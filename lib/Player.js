...
SqueezePlayer.prototype.unsync = function() {
  this.runCmd('sync -')
}

SqueezePlayer.prototype.pause = function() {
  this.runCmd('pause 1')
  this.runCmd('playlist pause 1')
}

SqueezePlayer.prototype.play = function() {
  this.runCmd('play')
  this.runCmd('playlist pause 0')
}
...
SqueezePlayer.prototype.registerEvents = function() {
  ...
  this.cli.on(this.mac + ' paused', function() {
    self.emit('pause')
  })

  this.cli.on(this.mac + ' play', function() {
    self.emit('play')
  })
